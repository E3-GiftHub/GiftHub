...
describe('Container', () => {
  ...
  it('applies top border style when ContainerBorderStyle.TOP is passed', () => {
    const { container } = render(<Container borderStyle={ContainerBorderStyle.TOP}>Top Border</Container>)
  ...
  it('applies bottom border style when ContainerBorderStyle.BOTTOM is passed', () => {
    const { container } = render(<Container borderStyle={ContainerBorderStyle.BOTTOM}>Bottom Border</Container>)
