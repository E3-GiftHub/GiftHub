...
export default function EventCardPage() {
  ...
  const event = {
    ...
    description: "Join us for a special birthday celebration! There will be cake, music, and lots of fun activities planned for everyone.",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Gift Hub event card demonstration page" />
      </Head>
