    ...
    <div>
      ...
      <div className={styles.aboutPage}>
        ...
        <p className={styles.intro}>
          <strong>GiftHub</strong> is a Peer-to-Peer Gifting Platform designed
          to simplify the process of gift-giving for special occasions like
          birthdays, weddings, or graduations.
          <br />
          Event Planners can manage wishlists, invite guests, and receive gifts
          or cash contributions in a seamless, collaborative environment.
        </p>

        <p className={styles.extendedDescription}>
          GiftHub solves the coordination chaos of group gifting. It provides a
          centralized space for planning, managing, and participating in
          gift-giving. Guests can contribute funds, reserve gifts, upload event
          memories, and communicate more efficiently. The platform integrates
          affiliate product APIs and payment processors like Stripe for secure
          and intuitive experiences. Designed with modern stacks and agile
          methodology, GiftHub is a robust, scalable solution for events of all
          kinds.
        </p>
        ...
        <div className={styles.tech}>
          ...
          <ul>
            <li>
              ✅ Built with the T3 stack (TypeScript, Tailwind, tRPC, Prisma)
            </li>
            <li>✅ Modular architecture following clean code principles</li>
            <li>
              ✅ Agile collaboration using GitHub Projects, Figma, and Notion
            </li>
