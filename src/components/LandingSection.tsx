...
export default function LandingSection() {
  return (
    <div className={styles['landing-container']}>
        <img src={'/illustrations/parachute.png'} alt='parachute gift' className={styles.parachute1} />
        <img src={'/illustrations/parachute.png'} alt='parachute gift' className={styles.parachute2} />
        <img src={'/illustrations/parachute.png'} alt='parachute gift' className={styles.parachute3} />
        <img src={'/illustrations/parachute.png'} alt='parachute gift' className={styles.parachute4} />
        <img src={'/illustrations/cloud.png'} alt='parachute gift' className={styles.cloud1} />
        <img src={'/illustrations/cloud.png'} alt='parachute gift' className={styles.cloud2} />
