...
CREATE TABLE "Mark" (
    ...
    CONSTRAINT "Mark_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "ItemCatalogue" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "EventArticle" (
    ...
    CONSTRAINT "EventArticle_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Event" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "EventArticle_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "ItemCatalogue" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Contribution" (
    ...
    CONSTRAINT "Contribution_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "ItemCatalogue" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "StripeLink" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "StripeLink_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "User" ("username") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "StripeLink_checkoutSessionId_key" ON "StripeLink"("checkoutSessionId");

-- CreateIndex
CREATE INDEX "StripeLink_creatorId_idx" ON "StripeLink"("creatorId");

-- CreateIndex
CREATE INDEX "StripeLink_eventId_idx" ON "StripeLink"("eventId");

-- CreateIndex
CREATE INDEX "StripeLink_articleId_idx" ON "StripeLink"("articleId");
